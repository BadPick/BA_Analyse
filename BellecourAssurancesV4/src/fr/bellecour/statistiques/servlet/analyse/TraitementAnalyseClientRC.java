...
/**
 * Servlet implementation class TraitementAnalyseClientRC
 */
@WebServlet("/TraitementAnalyseClientRC")
public class TraitementAnalyseClientRC extends HttpServlet
{
	 ...
	 */
	public TraitementAnalyseClientRC()
	{
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{			
			...
			try
			{
				...
				rd = getServletContext().getRequestDispatcher("/jsp/clientResultatAnalyseRC.jsp");
			} 
			catch (Exception e)
			{
				e.printStackTrace();
		...
		{
			message = "Aucun contrats sélectionnés pour l'analyse, ";
			rd = getServletContext().getRequestDispatcher("/jsp/clientAnalyse.jsp");
		}
		request.setAttribute("branche", branche);
		request.setAttribute("codeProduit", contratAAnalyser.getCodeProduit());
			...
			HashMap<String, String> listeAnneesTecn, Date dateDebut, Date dateFin) throws ParseException
	{
		...
		try
		{
			listeNatureBdd = NatureDao.getAllCodeAnalyse("rc");
